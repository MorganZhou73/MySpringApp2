...
public class EmployeeDTO {
	...
	public EmployeeDTO(Employees entity){
	...
	public Employees toEntity() throws ParseException{
		Employees employee = new Employees(this.employeeID, this.firstName, this.lastName);
